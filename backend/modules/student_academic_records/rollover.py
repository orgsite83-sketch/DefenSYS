...
def rollover_target_semester(record, target_school_year, action):
    ...
    # Within-year promotion (1st → 2nd Semester): stay in the record's own school year.
    # Cross-year promotion (2nd → 1st Semester) and retain: target the active school year.
