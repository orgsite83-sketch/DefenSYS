    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rolled_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rollover_children', to='student_academic_records.studentacademicrecord')),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('student', 'semester'), name='unique_student_record_per_semester')],
            },
        ),
    ]
