...
from .views import (
    ...
    SectionInstructorAssignmentDetailView,
    SectionInstructorAssignmentView,
...
urlpatterns = [
    ...
    path('pit-instructors/', SectionInstructorAssignmentView.as_view(), name='pit_instructor_assignments'),
    path(
        'pit-instructors/<int:assignment_id>/',
        SectionInstructorAssignmentDetailView.as_view(),
