...
SUGGESTED_DELIVERABLE_TEMPLATES = {
    'Concept Proposal': [
        ...
        {'id': 'D5', 'label': 'D5 - Signed Minutes (Concept)', 'required': True, 'type': 'pre'},
        {
            ...
            'required': False,
            'type': 'post',
            'archive_note': 'Uploaded to the archive after Concept defense is approved.',
        },
    ],
    'Project Proposal': [
        {'id': 'WPR', 'label': 'Weekly Progress Report', 'required': True, 'type': 'pre'},
        ...
        {'id': 'D13', 'label': 'D13 - Signed Matrix of Revision', 'required': True, 'type': 'pre'},
        {
            ...
            'required': False,
            'type': 'post',
            'archive_note': 'Uploaded to the archive after Proposal defense is approved.',
        },
    ],
    'Final Defense': [
        {'id': 'WPR', 'label': 'Weekly Progress Report', 'required': True, 'type': 'pre'},
        {'id': 'D14', 'label': 'D14 - Final Manuscript (Chapters 1-3)', 'required': True, 'type': 'pre'},
        {
            ...
            'required': False,
            'type': 'post',
            'archive_note': 'Restricted archive item after Final defense.',
        },
        {
            'id': 'D16',
        ...
        {'id': 'D17', 'label': 'D17 - 7-Page Executive Journal', 'required': False, 'type': 'post'},
        {'id': 'D18', 'label': 'D18 - Project Poster', 'required': False, 'type': 'post'},
        {'id': 'D19', 'label': 'D19 - Promotional Video', 'required': False, 'type': 'post'},
    ],
}
