...
flutter run --dart-define=DEFENSYS_API_HOST=192.168.1.20 
flutter run -d web-server --web-hostname 0.0.0.0 --web-port 57583 --dart-define=DEFENSYS_API_HOST=192.168.1.20
